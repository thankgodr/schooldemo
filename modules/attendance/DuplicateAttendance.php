...
//                                                                                    $count_dupf=DBGet(DBQuery('SELECT * FROM attendance_period WHERE STUDENT_ID=\''.$val2.'\' AND SCHOOL_DATE=\''.$val4.'\' AND COURSE_PERIOD_ID=\''.$val3.'\'  '));
//                                                                                    if(count($count_dupf)>0)
//                                                                                    DBQuery('DELETE FROM attendance_period WHERE STUDENT_ID=\''.$val2.'\' AND SCHOOL_DATE=\''.$val4.'\' AND COURSE_PERIOD_ID=\''.$val3.'\' AND PERIOD_ID!='.$sch_typ[1]['PERIOD_ID']);
