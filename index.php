...
############################################################################################
    ...
    elseif($student_RET)
    {
			...
			$date=date("Y-m-d H:i:s");
			DBQuery("INSERT INTO login_records (SYEAR,STAFF_ID,FIRST_NAME,LAST_NAME,PROFILE,USER_NAME,LOGIN_TIME,FAILLOG_COUNT,IP_ADDRESS,STATUS,SCHOOL_ID) values('".$_SESSION['UserSyear']."','".$student_RET[1][STUDENT_ID]."','".str_replace("'","''",$student_RET[1][FIRST_NAME])."','".str_replace("'","''",$student_RET[1][LAST_NAME])."','Student','".$student_RET[1][USERNAME]."','$date','".$student_RET[1][FAILED_LOGIN]."','$ip','Success','".$student_RET[1][SCHOOL_ID]."')");
...
//                    {
//                        unset($error);
//                        $error[] = "Incorrect username or password1. Please try again.";
//                        
//                    
//                    }
//                        else {
...
//                else{
//                    unset($error);
//                    $error[] = "Incorrect username or password2. Please try again.";
//                    }
//                
//            }
...
elseif($_REQUEST['modfunc']!='create_account')
{
    echo "
        <HTML>
            <HEAD><TITLE>".Config('TITLE')."</TITLE><link rel=\"shortcut icon\" href=\"favicon.ico\"><meta http-equiv='Content-Type' content='text/html; charset=utf-8'></HEAD>";
